...
| [PR-35](./PR-35-simplification-cleanup.md) | Simplification Cleanup | T7 | 27~34 | 완료(PR #47): 용어 일관화, 노출 정리, acceptance gate |
...
본 PR 트랙은 PR #47 병합으로 완료됐다. [`Overview.md`](./Overview.md) §8의 완료 기준(후보/published 상태경계, Enrichment Draft 범위, 대화 provenance 정책, 지식 맵 v1 범위, PR 단위 계획, 용어 일관성)은 각 PR 완료 기록과 [`contracts/terminology-map.md`](./contracts/terminology-map.md)의 PR-35 acceptance gate로 추적한다.
