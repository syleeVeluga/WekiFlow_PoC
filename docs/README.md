...
- OKF 선택(🟡) PR: [`okf-pr-19-external-enrichment.md`](./plans/okf-pr-19-external-enrichment.md), [`okf-pr-20-mcp-and-connectors.md`](./plans/okf-pr-20-mcp-and-connectors.md).
...
- `okf-knowledge-standard/` — OKF 도입 조사·제안·통합실행계획 + 구현기록(PR-01~18 완료).
