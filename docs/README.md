...
- [`dev-control-panel.md`](./archive/dev-control-panel.md), [`dev-control-panel/`](./archive/dev-control-panel/) — 슈퍼어드민 런타임 config·정책·Web 개발자 패널 계획(PR-21~25 완료).
- [`okf-enrichment-product-flow/`](./archive/okf-enrichment-product-flow/) — OKF enrichment 제품 흐름 재정렬 갭 분석 및 PR-26~35 구현 기록(완료).
...
- [`reference/source-to-official-knowledge-flow.md`](./reference/source-to-official-knowledge-flow.md) - source-only document visibility, `AI로 지식화`, and promotion into official knowledge surfaces.
- [`reference/testing.md`](./reference/testing.md) - current test gates, empty Playwright API harness, and OKF Markdown upload core E2E.
- [`archive/okf-core-pipeline-testing.md`](./archive/okf-core-pipeline-testing.md) - completed implementation plan for that E2E scenario.
