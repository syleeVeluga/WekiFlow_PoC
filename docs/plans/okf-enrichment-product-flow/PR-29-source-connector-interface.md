...
> Track T2/T3 공통 · 상태: 완료(PR #40) · 선행: [PR-26](./PR-26-candidate-contract.md) · 근거: [`Overview.md`](./Overview.md) §3.1(범용 Source 모델), [`Gap-Analysis.md`](./Gap-Analysis.md) §2.3·§2.7
...
- [x] 범용 `SourceConnector` 인터페이스가 정의되고 registry로 조회된다.
- [x] Slack/Drive/Meeting/Upload/URL 어댑터가 동일 인터페이스를 구현한다(외부는 mock).
- [x] mock 데이터로 후속 인입 PR이 end-to-end로 돌 수 있다.
- [x] 실제 자격증명/네트워크 없이 빌드·테스트가 통과한다.
