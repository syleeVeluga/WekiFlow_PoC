...
| [PR-32](./PR-32-review-triage.md) | Review Triage(위험도 라우팅) | T4 | 26,27 | needsReview 정책 결합, 승인 사유 inbox |
| [PR-33](./PR-33-knowledge-map.md) | Knowledge Map(링크 그래프 + 화면) | T5 | 26 | Markdown 링크 그래프, `wkf visualize`, 지식 맵 화면 |
| [PR-34](./PR-34-discovery-trust-and-ask.md) | Discovery Trust + Ask 화면 | T6 | 26,27,33 | 답변 출처·신뢰 표시, Q&A 화면 |
...
8. **PR-35**(정리) — 마지막. 단, 용어 매핑표는 PR-27부터 참조하도록 조기 작성.
